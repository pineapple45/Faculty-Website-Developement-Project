...
const collectionName = 'allumniInternshipStudentsImages';
...
const AllumniInternshipStudentsItem = model.allumniInternshipStudentsItem;
const Item = AllumniInternshipStudentsItem;
...
foo().then(res => {
  ...
  require('./get/secondgeneric')({
    router: router,
    gfs: gfs,
    renderedPage: 'allumni-internship-students',
    Item:Item,
  });
});
