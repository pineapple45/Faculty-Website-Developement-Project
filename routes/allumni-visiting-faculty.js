...
const collectionName = 'allumniVisitingFacultyImages';
...
const AllumniVisitingFacultyItem = model.allumniVisitingFacultyItem;
const Item = AllumniVisitingFacultyItem;
...
foo().then(res => {
  ...
  require('./get/secondgeneric')({
    router: router,
    gfs: gfs,
    renderedPage: 'allumni-visiting-faculty',
    Item:Item,
  });
});
