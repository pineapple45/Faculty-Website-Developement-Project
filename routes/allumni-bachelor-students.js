...
const collectionName = 'allumniBachelorStudentsImages';
...
const AllumniBachelorStudentsItem = model.allumniBachelorStudentsItem;
const Item = AllumniBachelorStudentsItem;
...
foo().then(res => {
  ...
  require('./get/secondgeneric')({
    router: router,
    gfs: gfs,
    renderedPage: 'allumni-bachelor-students',
    Item:Item,
  });
});
