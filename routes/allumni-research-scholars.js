...
const collectionName = 'allumniResearchScholarImages';
...
const AllumniResearchScholarItem = model.allumniResearchScholarItem;
const Item = AllumniResearchScholarItem;
...
foo().then(res => {
  ...
  require('./get/secondgeneric')({
    router: router,
    gfs: gfs,
    renderedPage: 'allumni-research-scholars',
    Item:Item,
  });
});
