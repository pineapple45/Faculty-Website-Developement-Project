...
const collectionName = 'allumniMastersStudentsImages';
...
const AllumniMastersStudentsItem = model.allumniMastersStudentsItem;
const Item = AllumniMastersStudentsItem;
...
foo().then(res => {
  ...
  require('./get/secondgeneric')({
    router: router,
    gfs: gfs,
    renderedPage: 'allumni-masters-students',
    Item:Item,
  });
});
