...
const collectionName = 'cmVisitingFacultyImages';
...
const CmVisitingFacultyItem = model.cmVisitingFacultyItem;
const Item = CmVisitingFacultyItem;
...
foo().then(res => {
  ...
  require('./get/secondgeneric')({
    router: router,
    gfs: gfs,
    renderedPage: 'cm-visiting-faculty',
    Item:Item,
  });
});
