...
const collectionName = 'allumniProjectFellowImages';
...
const AllumniProjectFellowItem = model.allumniProjectFellowItem;
const Item = AllumniProjectFellowItem;
...
foo().then(res => {
  ...
  require('./get/secondgeneric')({
    router: router,
    gfs: gfs,
    renderedPage: 'allumni-project-fellow',
    Item:Item,
  });
});
