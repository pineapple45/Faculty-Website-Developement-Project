...
const collectionName = 'cmBachelorStudentsImages';
...
const CmBachelorStudentsItem = model.cmBachelorStudentsItem;
const Item = CmBachelorStudentsItem;
...
foo().then(res => {
  ...
  require('./get/secondgeneric')({
    router: router,
    gfs: gfs,
    renderedPage: 'cm-bachelor-students',
    Item:Item,
  });
});
